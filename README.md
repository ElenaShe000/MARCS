...
# Introduction 
 ...
 In turn, the synoptic atmospheric processes determine regional distribution of precipitation, evaporation, river runoff and water resource of lakes and aquifers. The changed atmospheric circulation leads to weather and hydrological extreme events latest often observed in many European countries (XXX; XXX). Among others, increase of water level in rivers, lakes and artifical reservoirs may lead to overflooded of large territories. Extreme floods damage social infrastructure (roads, bridges, pipes and hydraulic constraction of hydropower plants), kill people and result to economical losses.  Therefore, the early prediction of these extremes is among the actual task for national hydrometorological service. This study contributed to improving methods of seasonal prediction of floods. 
